...
double my_angle = 0.0;
double my_avg_angle = 0.0;
double my_left = 0.0;
double my_right = 0.0;
double my_left2 = 0.0;
double my_right2 = 0.0;
...
void Calc_Right(const std_msgs::Int16& rightCount) {
  ...
  if(rightCount.data != 0 && lastCountR != 0) {
    ...
    my_right2 = my_right2 + distanceRight;
   // ROS_INFO("my_right_original: %lf\n", my_right2);
...
void update_odom() {
  ...
  my_distance = my_distance+ cycleDistance;
  my_angle = my_angle + cycleAngle;
  my_avg_angle = my_avg_angle + avgAngle;
  my_right = my_right + distanceRight;
  my_left = my_left + distanceLeft;
  // ROS_INFO("my_distance: %lf\n", my_distance);
  // ROS_INFO("my_distance: %lf\n", my_angle);
  // ROS_INFO("my_right: %lf\n", my_right);
  // ROS_INFO("my_left: %lf\n", my_left);
...
int main(int argc, char **argv) {
  ...
  while(ros::ok()) {
    ...
    loop_rate.sleep();
    //time4 = clock();
    // ROS_INFO("update_time: %lf\tpublish_time: %lf\tspin_time: %lf\ttotal_time: %lf", (double)(time2-time1), (double)(time3-time2), (double)(time4-time3), (double)(time4-time1));
