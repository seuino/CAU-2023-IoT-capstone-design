...
const double TICKS_PER_REVOLUTION = 12*210; // For reference purposes.
const double WHEEL_RADIUS = 0.060/2; // Wheel radius in meters
const double WHEEL_BASE = 0.210; // Center of left tire to center of right tire
const double TICKS_PER_METER = (210.0*12.0)*(1/(60*1e-3*PI)); // Original was 2800
...
//   // geometry_msgs::TransformStamped base_link_transformStamped;
//   // geometry_msgs::TransformStamped camera_link_transformStamped;
//   // geometry_msgs::TransformStamped camera_imu_transformStamped;


//   static tf2_ros::StaticTransformBroadcaster static_broadcaster;  
//   // static tf2_ros::StaticTransformBroadcaster camera_br;
//   static tf2_ros::StaticTransformBroadcaster map_br;
//   // static tf2_ros::StaticTransformBroadcaster camera_link_br;
//   // static tf2_ros::StaticTransformBroadcaster camera_imu_br;
...
//   map_q.setRPY(0, 0, 0);
//   map_transformStamped.header.stamp = odomNew.header.stamp;
//   map_transformStamped.header.frame_id = "map";
//   map_transformStamped.child_frame_id = "odom";
//   map_transformStamped.transform.translation.x = 1;
//   map_transformStamped.transform.translation.y = 0;
//   map_transformStamped.transform.translation.z = 0;

//   map_transformStamped.transform.rotation.x = map_q.x();
//   map_transformStamped.transform.rotation.y = map_q.y();
//   map_transformStamped.transform.rotation.z = map_q.z();
//   map_transformStamped.transform.rotation.w = map_q.w();
...
//   static_broadcaster.sendTransform(odom_transformStamped);
...
// //   camera_imu_transformStamped.header.stamp = odomNew.header.stamp;
// //   camera_imu_transformStamped.header.frame_id = "camera_link";
// //   camera_imu_transformStamped.child_frame_id = "camera_imu_optical_frame";
// //   camera_imu_transformStamped.transform.translation.x = 0;
// //   camera_imu_transformStamped.transform.translation.y = 0;
// //   camera_imu_transformStamped.transform.translation.z = 0;

// //   camera_imu_transformStamped.transform.rotation.x = camera_link_q.x();
// //   camera_imu_transformStamped.transform.rotation.y = camera_link_q.y();
// //   camera_imu_transformStamped.transform.rotation.z = camera_link_q.z();
// //   camera_imu_transformStamped.transform.rotation.w = camera_link_q.w();
// //   camera_imu_br.sendTransform(camera_imu_transformStamped);

// // //  tf2::Quaternion camera_q;
// // //  camera_q.setRPY(-PI/2, 0, -PI/2);
// // //  base_link_transformStamped.header.stamp = odomNew.header.stamp;
// // //  base_link_transformStamped.header.frame_id = "camera_link";
// // //  base_link_transformStamped.child_frame_id = "camera_depth_optical_frame";
// // //  base_link_transformStamped.transform.translation.x = 0.06;
// // //  base_link_transformStamped.transform.translation.y = 0;
// // //  base_link_transformStamped.transform.translation.z = 0.04;

// // //  base_link_transformStamped.transform.rotation.x = camera_q.x();
// // //  base_link_transformStamped.transform.rotation.y = camera_q.y();
// // //  base_link_transformStamped.transform.rotation.z = camera_q.z();
// // //  base_link_transformStamped.transform.rotation.w = camera_q.w();
// // //  camera_br.sendTransform(base_link_transformStamped);
